...
import { AnimationItem, AnimationConfigWithData, AnimationConfigWithPath } from "lottie-web/build/player/lottie_light";
 ...
 *
 */
export default function useLottie({ container, animationFile, options }: useLottieProps) {
