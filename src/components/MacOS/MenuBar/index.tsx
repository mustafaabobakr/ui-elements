		...
		<div
			...
			<div className="flex items-center">
				<button
					...
					<img alt="apple icon" className="w-3.5" src="/macos/apple-logo.png" />
			...
			<div className="flex flex-row justify-center items-center">
				<button className="w-8 h-5 mr-5 mt-0.5">
					<img alt="menubar icon" className="w-full h-full" src="/macos/battery-icon.png" />
				</button>
				<button className="w-4 mr-5">
					<img alt="menubar icon" className="w-full" src="/macos/wifi-icon.png" />
				</button>
				<button className="w-4 mr-5">
					<img alt="menubar icon" className="w-full" src="/macos/magnifier-icon.png" />
				</button>
				<button className="w-3.5 mr-5">
					<img alt="menubar icon" className="w-full" src="/macos/control-center-icon.png" />
				</button>
				<button className="w-3.5 mr-5">
					<img alt="menubar icon" className="w-full" src="/macos/siri-logo.png" />
				</button>
				<button className="flex flex-row justify-center items-center">
					<p className="text-sm text-white mr-2">Tue 9 Apr</p>
					<p className="text-sm text-white mr-5">3:23AM</p>
				</button>
			</div>
		</div>
	);
