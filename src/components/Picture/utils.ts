export const shimmer = (w: number, h: number, border?: number, placeholderImageBackground?: string) => {
...
) => `data:image/svg+xml;base64,${toBase64(shimmer(width, height, borderRadius, placeholderImageBackground))}`
