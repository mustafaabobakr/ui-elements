...
const GlassMenu: React.FC<GlassMenuProps> = ({
  onWatchClick,
  onPricingClick,
  onDownloadClick,
}: GlassMenuProps) => {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          aria-expanded="false"
          className="flex items-center group justify-center  relative"
        >
          <GlassMenuButton
            text="Pricing"
            icon={<PricingIcon />}
          ...
          <div className="flex sm:overflow-hidden pointer-events-none absolute h-screen w-screen z-[100] bottom-[42px] left-0 right-0 -translate-x-full sm:-translate-x-1/2">
            <div
              ...
              style={{
                ...
                width: 64,
                transform:
                  "translateX(-12px) translateY(24px) scale(0.9) rotate(0deg) translateZ(0px)",
              }}
            >
            ...
            <div
              ...
              style={{
                ...
                width: 64,
                transform:
                  "translateX(-12px) translateY(24px) scale(0.9) rotate(-0.858407deg) translateZ(0px)",
              }}
            >
              <div className="flex size-16 shrink-0 rounded-lg  group-hover/row:scale-105 scale-100 transition-transform pointer-events-none">
                <img
            ...
            <div
              ...
              style={{
                ...
                width: 64,
                transform:
                  "translateX(-12px) translateY(24px) scale(0.9) rotate(-1.71681deg) translateZ(0px)",
              }}
            >
              <div className="flex size-16 shrink-0 rounded-lg  group-hover/row:scale-105 scale-100 transition-transform pointer-events-none">
            ...
            <div
              ...
              style={{
                ...
                width: 64,
                transform:
                  "translateX(-12px) translateY(24px) scale(0.9) rotate(-2.57522deg) translateZ(0px)",
              }}
            >
            ...
            <div
              ...
              style={{
                ...
                width: 64,
                transform:
                  "translateX(-12px) translateY(24px) scale(0.9) rotate(-3.43363deg) translateZ(0px)",
              }}
            >
              <div className="flex size-16 shrink-0 rounded-lg  group-hover/row:scale-105 scale-100 transition-transform pointer-events-none bg-black/40 shadow-xl">
                <img
...
export default React.memo(GlassMenu);
